/*1446071788,,JIT Construction: v2013296,en_US*/
...
{
api_key:appID,
payload:ES('JSON','stringify',false,payload)});},{params:[[appID,'string','appID'],[eventName,'string','eventName'],[valueToSum,'?number','valueToSum'],[params,'?object','params']]});}__annotator(logEvent,{'module':'sdk.AppEvents','line':51,'column':0,'name':'logEvent'},{params:['string','string','?number','?object']});
...
return true;},{params:[[eventName,'string','eventName']],returns:'boolean'});}__annotator(isValidEventName,{'module':'sdk.AppEvents','line':81,'column':0,'name':'isValidEventName'},{params:['string'],returns:'boolean'});
...
params,
extraParams));},{params:[[appID,'string','appID'],[purchaseAmount,'number','purchaseAmount'],[currency,'string','currency'],[params,'?object','params']]});}__annotator(logPurchase,{'module':'sdk.AppEvents','line':93,'column':0,'name':'logPurchase'},{params:['string','number','string','?object']});




function activateApp(appID){return __bodyWrapper(this,arguments,function(){
logEvent(appID,HiddenEventNames.ACTIVATED_APP);},{params:[[appID,'string','appID']]});}__annotator(activateApp,{'module':'sdk.AppEvents','line':112,'column':0,'name':'activateApp'},{params:['string']});
...
ParameterNames:ParameterNames};},{'module':'sdk.AppEvents','line':0,'column':0,'name':'$module_sdk_AppEvents'}),null);
...
AppEvents.logEvent(appID,eventName,valueToSum,params);},{params:[[eventName,'string','eventName'],[valueToSum,'?number','valueToSum'],[params,'?object','params']]});},{'module':'legacy:fb.appevents','line':15,'column':10},{params:['string','?number','?object']}),
...
AppEvents.logPurchase(appID,purchaseAmount,currency,params);},{params:[[purchaseAmount,'number','purchaseAmount'],[currency,'string','currency'],[params,'?object','params']]});},{'module':'legacy:fb.appevents','line':36,'column':13},{params:['number','string','?object']}),
...
AppEvents.activateApp(appID);},{'module':'legacy:fb.appevents','line':57,'column':13}),


EventNames:AppEvents.EventNames,

ParameterNames:AppEvents.ParameterNames});},{'module':'legacy:fb.appevents','line':0,'column':0,'name':'$module_legacy_fb_appevents'}),3);
...
Event.unsubscribe(Event.SUBSCRIBE,subscriptionAdded);},{params:[[name,'string','name'],[callbacks,'array','callbacks']]});}__annotator(subscriptionAdded,{'module':'legacy:fb.canvas.syncrequests','line':10,'column':0,'name':'subscriptionAdded'},{params:['string','array']});


Event.subscribe(Event.SUBSCRIBE,subscriptionAdded);},{'module':'legacy:fb.canvas.syncrequests','line':0,'column':0,'name':'$module_legacy_fb_canvas_syncrequests'}),3);
...
RPC.remote.useFriendsOnline(true);}},{params:[[name,'string','name'],[callbacks,'array','callbacks']]});}__annotator(subscriptionAdded,{'module':'legacy:fb.canvas.presence','line':13,'column':0,'name':'subscriptionAdded'},{params:['string','array']});
...
RPC.remote.useFriendsOnline(false);}},{params:[[name,'string','name'],[callbacks,'array','callbacks']]});}__annotator(subscriptionRemoved,{'module':'legacy:fb.canvas.presence','line':22,'column':0,'name':'subscriptionRemoved'},{params:['string','array']});},{'module':'legacy:fb.canvas.presence','line':0,'column':0,'name':'$module_legacy_fb_canvas_presence'}),3);
...
Runtime.setIsVersioned(true);},{'module':'legacy:fb.versioned-sdk','line':0,'column':0,'name':'$module_legacy_fb_versioned_sdk'}),3);
